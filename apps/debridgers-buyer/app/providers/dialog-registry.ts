 ...
 *
 * To add a dialog:
 *   1. Build the presentation component in packages/ui-web (pure props in, no data fetching or routing knowledge).
 *   2. Build a thin glue component in app/components/dialogs/ that wires useDialog() and useDialogSubmission() around it.
...
export const DIALOG_REGISTRY: DialogRegistry = {
  ...
  RATE_ORDER: () => import("../components/dialogs/RateOrderDialog"),
};
