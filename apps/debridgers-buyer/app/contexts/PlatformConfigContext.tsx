...
/*
 * The API serves `commissionPercent` as a PERCENTAGE (5), not a fraction (0.05); `commissionRate` is the fraction form.
 * Both are exposed deliberately: the same ambiguity already caused a real bug server-side, where a stored percentage would have been multiplied as-is rather than divided down first, so no call site should have to remember which form it received.
