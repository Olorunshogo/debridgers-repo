 ...
 * Registered as PAYMENT_METHOD in app/providers/dialog-registry.ts.
 *
 * Step two of checkout: the order already exists as pending and unpaid, and every figure below was priced by the server when it was created.
 * Nothing here recomputes a total, so what the buyer was shown is what gets charged.
 */
...
export default function PaymentMethodDialog({
  ...
  /*
   * Blocks Escape and backdrop dismissal mid-payment.
   * Clicking away from a half-submitted charge is the expensive kind of accident.
   */
  useEffect(() => {
