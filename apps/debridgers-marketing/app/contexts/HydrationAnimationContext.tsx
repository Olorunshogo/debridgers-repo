...
export function HydrationAnimationProvider({
  ...
  /*
   * Runs the hydration animation only on a first visit without reduced motion.
   * The localStorage flag persists that decision so returning visitors and reduced-motion users skip it entirely.
   */
  useEffect(() => {
