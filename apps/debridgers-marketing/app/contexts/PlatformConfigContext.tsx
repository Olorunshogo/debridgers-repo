 ...
 * `distance_base_fee_kobo`, `distance_rate_per_km_kobo` and `distance_rounding_kobo` are the universal delivery-fee formula.
 * The per-LGA distance itself lives on the zone, not here.
 */
