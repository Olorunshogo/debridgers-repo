 ...
 * not new markup.
 *
 * `?role=` short-circuits the picker: the agents page and other role-specific
 * CTAs link straight to `/signup?role=agent`, and a visitor who already picked
 * should not have to pick again.
 */
