...
export default function ConfirmDialog({
  ...
  /*
   * Typed boolean rather than void so success is distinguishable.
   * run resolves undefined when the action throws, which a void action cannot be told apart from a successful one.
   */
