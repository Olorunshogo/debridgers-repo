...
export class CareersController {
  constructor(
    ...
    private readonly people: CareersPeopleService,
    private readonly ops: CareersOpsService,
  ...
  async apply(
    ...
    const cvUrl = cv?.buffer
      ? await this.cloudinary.uploadDocument(
          cv.buffer,
          "debridgers/careers-cvs",
          cv.originalname,
        )
      : undefined;
    return this.careers.apply(jobId, dto, cvUrl);
  }
  ...
  myApplications(@CurrentUser() user: JwtPayload) {
    return this.careers.listMyApplications(user);
  }
  ...
  myOffers(@CurrentUser() user: JwtPayload) {
    return this.careers.listMyOffers(user);
  }
  ...
  acceptOffer(
    ...
    return this.careers.acceptOffer(id, user);
  }
  ...
  rejectOffer(
    ...
    return this.careers.rejectOffer(id, user);
  }
  ...
  scheduleMyInterview(
    ...
    return this.careers.scheduleInterviewAsApplicant(id, dto, user);
  }
  ...
  listJobsForCareers() {
    return this.careers.listJobsForCareers();
  }
  ...
  createJob(@Body() body: unknown, @CurrentUser() user: JwtPayload) {
    ...
    return this.careers.createJob(dto, user);
  }
  ...
  updateJob(@Param("id", ParseIntPipe) id: number, @Body() body: unknown) {
    ...
    return this.careers.updateJob(id, dto);
  }
  ...
  listApplications(@Query("job_id") jobId?: string) {
    ...
    if (parsed !== undefined && Number.isNaN(parsed)) {
      return this.careers.listApplications(undefined);
    }
    return this.careers.listApplications(parsed);
  }
  ...
  async applicationCv(@Param("id", ParseIntPipe) id: number) {
    const application = await this.careers.getApplication(id);
  ...
  screenApplication(
    ...
    return this.careers.screenApplication(id, dto);
  }
  ...
  scheduleInterview(
    ...
    return this.careers.scheduleInterview(id, dto);
  }
  ...
  updateInterview(
    ...
    return this.careers.updateInterview(id, dto);
  }
  ...
  createOffer(
    ...
    return this.careers.createOffer(id, dto, user);
  }
  ...
  careersAcceptOffer(@Param("id", ParseIntPipe) id: number) {
    return this.careers.careersAcceptOffer(id);
  }
