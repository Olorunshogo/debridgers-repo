 ...
 * The distance_base_fee/distance_rate_per_km/distance_rounding fields are the universal delivery-fee formula; the per-LGA distance itself lives on the zone, not here.
 */
