...
/*
 * One step only: request the reset link.
 * The link itself carries the actual reset token to /reset-password - there is no code to type here, so this page never collects a password.
