...
const NAV: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      {
        href: "/careers-dashboard/recruitment",
        label: "Jobs & pipeline",
        icon: Briefcase,
        roles: ["admin"],
      },
      {
        href: "/careers-dashboard/applications",
        label: "My applications",
        icon: Inbox,
        roles: ["applicant", "employee"],
      },
      {
        href: "/careers-dashboard/offers",
        label: "Offers",
        icon: FileText,
        roles: ["applicant", "employee"],
      },
      {
        href: "/careers-dashboard/contracts",
        label: "Contracts",
        icon: FileSignature,
        roles: ["applicant", "employee"],
      },
  ...
  },
  {
    ...
    items: [
      {
        href: "/careers-dashboard/people",
        label: "Directory",
        icon: Users,
        roles: ["admin", "employee"],
      },
      {
        href: "/careers-dashboard/performance",
        label: "Performance",
        icon: ClipboardList,
        roles: ["admin", "employee"],
      },
      {
        href: "/careers-dashboard/reports",
        label: "Reports",
        icon: FolderKanban,
        roles: ["admin", "employee"],
      },
      {
        href: "/careers-dashboard/policies",
        label: "Policies",
        icon: Shield,
        roles: ["admin", "employee"],
      },
      {
        href: "/careers-dashboard/analytics",
        label: "Analytics",
        icon: BarChart3,
        roles: ["admin"],
      },
...
const TITLES: Record<string, string> = {
  "/careers-dashboard": "Overview",
  "/careers-dashboard/recruitment": "Recruitment",
  "/careers-dashboard/applications": "My applications",
  "/careers-dashboard/offers": "Offers",
  "/careers-dashboard/contracts": "Contracts",
  "/careers-dashboard/people": "People",
  "/careers-dashboard/performance": "Performance",
  "/careers-dashboard/reports": "Reports",
  "/careers-dashboard/policies": "Policies",
  "/careers-dashboard/analytics": "Analytics",
};
...
export default function DashboardLayout() {
  ...
  const pageTitle =
    TITLES[pathname] ??
    (pathname.startsWith("/careers-dashboard/recruitment/jobs/")
      ? "Job pipeline"
      : "Dashboard");
      ...
      <div className="flex h-full flex-col">
        <div className="flex min-h-0 flex-1 flex-col gap-6 overflow-y-auto rounded-xl bg-[#FCFDFD] p-4 pt-6">
          <div className="mx-auto flex h-16 items-center">
            <Link to="/careers-dashboard" onClick={onNavClick}>
              <AppLogo />
            </Link>
          </div>
