...
export default defineConfig({
  ...
  server: {
    /*
     * 5176 matches the deployed test backend's ALLOWED_ORIGINS - a different port here means every local request gets CORS-blocked, not the "port in use" a bare mismatch usually looks like.
