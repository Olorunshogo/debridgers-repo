 ...
 * This is the only place those three concerns meet the hooks. Keeping it here rather than inside ui-web is what lets the hooks be shared without dragging the API client and router into a UI package.
 */
  ...
  const adapter = useMemo<AuthAdapter>(
    () => ({
      ...
      updatePassword: (currentPassword, newPassword) =>
        apiMutate("/admin/password/change", {
          method: "PATCH",
          body: JSON.stringify({
