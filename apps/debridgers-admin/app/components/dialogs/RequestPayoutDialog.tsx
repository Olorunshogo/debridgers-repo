 ...
 * The presentation component in @debridgers/ui-web knows nothing about fetching or routing; this file is the only place they meet. Registered as REQUEST_PAYOUT in app/providers/dialog-registry.ts.
...
export default function RequestPayoutDialog({
  ...
  /*
   * Hold the success panel long enough to read, then close. Closing the instant the promise resolves reads as if nothing happened.
   */
  useEffect(() => {
