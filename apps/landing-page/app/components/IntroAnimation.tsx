...
const PHASE_DURATIONS = {
  1: 2500, // letter slide-in
  2: 2000, // letter slide-out
    ...
    <div className="flex items-center justify-center">
      {LETTERS.map((letter, i) => (
        <motion.span
          ...
          className="font-syne text-4xl font-bold text-white sm:text-5xl lg:text-6xl"
        >
          {letter}
        </motion.span>
      ))}
    ...
    <div className="flex items-center justify-center">
      {LETTERS.map((letter, i) => (
        <motion.span
          ...
          className="font-syne text-5xl font-bold text-white sm:text-6xl lg:text-7xl"
        >
          {letter}
        </motion.span>
      ))}
...
function ProgressBar() {
  return (
    <div className="mt-8 h-[3px] w-full max-w-[400px] overflow-hidden rounded-full bg-white/15">
      <motion.div
    ...
    <AnimatePresence>
      {phase !== "done" && (
        <motion.div
          ...
          className="fixed inset-0 z-9999 flex flex-col items-center justify-center bg-[#0D2B12]"
