...
export default function OutreachPage() {
  ...
  function handleChange(field: keyof typeof form, value: string) {
    ...
    if (field === "lga") setForm((p) => ({ ...p, lga: value, area: "" }));
  }
  ...
  return (
    <>
      ...
      {/* Hero banner */}
      <div className="bg-primary px-section-px sm:px-section-px-sm lg:px-section-px-lg py-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="font-open-sans mx-auto max-w-xl text-base leading-relaxed text-white/80">
            Fill in the form below and a Debridgers agent will reach out to you
            within 24 hours — whether you want bulk orders, regular deliveries,
      ...
      {/* Main content */}
      <section className="px-section-px sm:px-section-px-sm lg:px-section-px-lg bg-[#F6F3F3] py-12">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-heading text-sm font-medium">
                      Business / Shop Name{" "}
                      <span className="text-text font-normal">(optional)</span>
                    </label>
                    <input
                      type="text"
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <ul className="flex flex-col gap-3">
                {[
                  ...
                  "We source products at market prices — no markups",
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <p className="text-text mb-3 text-sm">
                Prefer to chat directly? Send us a message on WhatsApp — we're
                always available.
              </p>
