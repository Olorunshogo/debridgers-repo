...
for f in apps/landing-page/public/images/_.{jpg,png} apps/landing-page/public/logos/_.png; do
cwebp -q 80 "$f" -o "${f%.\*}.webp"
done
If you'd rather use sharp-cli (Node-based, no system install needed):

npx sharp-cli --input "apps/landing-page/public/images/_.{jpg,png}" --output "apps/landing-page/public/images/" --format webp --quality 80
npx sharp-cli --input "apps/landing-page/public/logos/_.png" --output "apps/landing-page/public/logos/" --format webp --quality 80
Or the simplest option if you have imagemagick:

find apps/landing-page/public/images apps/landing-page/public/logos -name "_.jpg" -o -name "_.png" | xargs -I{} sh -c 'convert "{}" -quality 80 "${1%.\*}.webp"' \_ {}
