...
**Debridgers — Core Commercial Metrics**

### 1. GMV: Gross Merchandise Value

The total value of goods sold through Debridgers before deducting costs, fees, refunds, discounts, or commissions.

**For Debridgers:**
GMV = Total value of all customer orders

**Example:**
100 orders × ₦20,000 average order value = ₦2,000,000 GMV
...
**Example:**
₦2,000,000 GMV ÷ 100 orders = ₦20,000 AOV

### 3. Revenue

The money Debridgers actually earns from its transactions, rather than the total value of goods sold.

**Example:**
₦2,000,000 GMV with a 10% platform commission = ₦200,000 revenue

### 4. Gross Margin

The percentage of revenue left after paying the direct costs required to deliver the product/service.

**Formula:**
Gross Margin = (Revenue − Direct Costs) ÷ Revenue × 100

**Example:**
₦200,000 revenue − ₦120,000 direct costs = ₦80,000 gross profit
Gross margin = 40%

### 5. Gross Profit

The actual amount of money left after subtracting direct costs from revenue.
...
The amount left from each transaction after all variable costs associated with that transaction are paid.

For Debridgers, this could include:

- Supplier/product costs, where applicable
- Agent commissions
- Referral commissions
- Payment processing fees
- Delivery costs/subsidies
- Other transaction-level costs

**Formula:**
Contribution Margin = Revenue - Variable Costs

This is especially important because a business can have positive revenue but still lose money on every order.
...
The average amount Debridgers spends to acquire one new paying customer.

**Formula:**
CAC = Sales & Marketing Spend ÷ Number of New Customers Acquired

**Example:**
₦500,000 spent on marketing to acquire 100 new customers = ₦5,000 CAC

### 9. LTV: Customer Lifetime Value

The estimated total gross profit Debridgers expects to generate from a customer over the entire relationship.

A simple version:

**LTV ≈ AOV × Purchase Frequency × Gross Margin % × Customer Lifetime**

For an early-stage company, this is often only an estimate until enough repeat-purchase data exists.

### 10. LTV: CAC Ratio

A comparison between how much economic value a customer generates and how much it costs to acquire them.

**Formula:**
LTV:CAC = LTV ÷ CAC

**Example:**
₦30,000 LTV ÷ ₦10,000 CAC = 3:1

A higher ratio is generally better, but the quality of the underlying LTV and CAC assumptions matters.

### 11. Repeat Rate

The percentage of customers who purchase again after their first purchase.

**Formula:**
Repeat Rate = Customers Who Purchased More Than Once ÷ Total Customers × 100

This is one of the most important metrics for determining whether customers actually want to continue using Debridgers.

### 12. Retention

The percentage of customers who remain active or continue purchasing over a defined period.

**Example:**
If 100 customers purchased in January and 40 of them purchase again in February, February customer retention is 40%.

### 13. Active Agents

The number of agents who are actually generating meaningful activity within Debridgers during a defined period.

A useful definition might be:

**Active Agent = An agent who generates at least one completed order during the period.**

This is better than simply counting registered agents.

### 14. Agent Activation Rate

The percentage of registered agents who become active.

**Formula:**
Agent Activation Rate = Active Agents ÷ Registered Agents × 100

### 15. Orders

The number of customer transactions completed through Debridgers.

Orders are important, but **orders alone do not tell you whether the business is economically viable**. You need to pair them with GMV, AOV, revenue, margin, and repeat rate.

### 16. Conversion Rate

The percentage of potential customers who complete a desired action, usually placing an order.

**Example:**
1,000 people visit a product page and 30 place orders:

Conversion Rate = 30 ÷ 1,000 × 100 = 3%

### 17. CAC: Payback Period

How long it takes for the gross profit generated by a new customer to recover the cost of acquiring that customer.

**Example:**
CAC = ₦10,000
Customer generates ₦2,500 contribution profit per month

CAC Payback = 4 months

### 18. Burn Rate

How much cash Debridgers loses/spends per month to operate the company.

**Example:**
If Debridgers spends ₦3 million per month and receives ₦1 million in operating cash inflows, net burn is ₦2 million/month.

### 19. Runway

How long Debridgers can continue operating before running out of available cash, assuming the current burn rate.

**Simple Formula:**
Runway = Cash Available ÷ Monthly Net Burn

**Example:**
₦12 million cash ÷ ₦2 million monthly burn = 6 months of runway

### 20. Take Rate

The percentage of GMV that Debridgers captures as revenue.

**Formula:**
Take Rate = Revenue ÷ GMV × 100

**Example:**
₦200,000 revenue from ₦2,000,000 GMV = 10% take rate

### 21. Refund / Cancellation Rate

The percentage of orders that are refunded or cancelled.

**Formula:**
Refund/Cancellation Rate = Refunded or Cancelled Orders ÷ Total Orders × 100

This matters because reported GMV can look healthy while actual realized revenue is much lower.

### 22. Supplier Count

The number of suppliers actively providing products that can be sold through Debridgers.

For commercial analysis, distinguish between:

- **Registered suppliers** — suppliers who have signed up
- **Active suppliers** — suppliers currently supplying/selling products
- **Transacting suppliers** — suppliers who have actually generated completed orders

### 23. Net Revenue

Revenue remaining after deductions such as refunds, discounts, rebates, or other applicable adjustments.

This is usually a more useful figure for evaluating the actual economics of the business than gross transaction value.

### The Most Important Metrics for Debridgers Right Now

Given only 10 orders, I would prioritize these:
...
10. **New Customers**
11. **CAC**
12. **Refund/Cancellation Rate**
13. **Monthly Burn**
14. **Runway**

The immediate objective is not to maximize all of these simultaneously. It is to establish whether **each additional order creates attractive economics and whether customers/agents come back without excessive acquisition spending.**
