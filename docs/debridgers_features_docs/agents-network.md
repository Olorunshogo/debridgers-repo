...
- Cost per pack: the product's catalogue price less the agent's banded
  commission. For Local White Rice: ₦42,000 - ₦1,000 = ₦41,000 (4,100,000 kobo)
- Total: 10 × 4,100,000 = 41,000,000 kobo, being ₦410,000
...
- System auto-calculates: **Commission = a flat naira amount per package**, not
  a percentage of sale amount. Correction, 2026-08-29: this doc previously said
  amount × 5%, which does not match the code or database. Rates: beans ₦1,200,
  rice ₦1,000, oil ₦700, everything else ₦400 per package.
  - Example: 5 packs of an "everything else" product = 5 × ₦400 = ₦2,000 commission
...
Agent Submits Sales Report
    ...
    ↓
System Calculates Commission: flat rate per package (beans ₦1,200, rice ₦1,000, oil ₦700, else ₦400), not a percentage of sale amount
    ↓
...
└──────────────────────────────────────────────┘
    ...
    │  ├─ amount (flat per pack)   │ │└─ created_at    │
    │  ├─ status: pending/paid     │ └─────────────────┘
    │  ├─ paid_at (nullable)       │
    │  └─ created_at               │
    └──────────────────────────────┘
...
- [x] Stock request system (quantity × the product's remit price)
...
- [x] Commission auto-calculation (flat naira amount per package, keyed to product type)
...
- Request packs from warehouse, priced per product
...
- Automatic flat per-package commission on all sales (not a percentage)
...
- Formula: flat naira amount per package, keyed to product type (beans ₦1,200,
  rice ₦1,000, oil ₦700, else ₦400), not a percentage of sale amount
- Example: 5 packs of an "everything else" product = 5 × ₦400 = ₦2,000 commission
...
- Transparent earnings with automatic flat per-package commission
