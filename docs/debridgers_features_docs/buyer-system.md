...
> **Re-cost before building.** The ₦500 figures on this page were set against a
> ₦1,400 product. Against a ₦42,000 bag that is a 1.2% discount, which will not
> motivate anyone. See `docs/business/BusinessModel.md`.
